  ...
  <form action="../cliente/pedido.php" method="post" name="form1" id="form1">
    <table align="center">
      <tr valign="baseline">
        ...
        <td><input class="fields" name="producto" type="hiddentext" value="masa" size="32" readonly="readonly"</td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        ...
        <td><input class="fields" name="precio" type="hiddentext" id="preciocompra1" value="9" size="32" readonly="readonly" /></td>
      </tr>
      <tr valign="baseline">
