...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input name="producto" type="hiddentext" value="Salsa" size="32" readonly="readonly"</td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input name="precio" type="hiddentext" id="preciocompra1" value="10" size="32" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
