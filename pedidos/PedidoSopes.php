...
<head>
  ...
  <style type="text/css">
  body {
    background-image: url('../img/sopes.jpg');
  ...
  <form action="../cliente/pedido.php" method="post" name="form1" id="form1">
    <table align="center">
      <tr valign="baseline">
        ...
        <td><input class="fields" name="producto" type="hiddentext" value="Sopes" size="32" readonly="readonly"></td>
      </tr>
      <tr valign="baseline">
