...
<head>
  ...
  <style type="text/css">
  body {
    background-image: url('../img/tlacoyos');
 ...
 <form action="../cliente/pedido.php" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input class="fields" name="producto" type="hiddentext" value="Tlacoyos" size="32" readonly="readonly"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input class="fields" name="precio" type="text" id="preciocompra1" value="13" size="32" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Total:</td>
      <td><input class="fields" name="total" type="text" id="totalcompra1" value="" size="32" readonly="readonly"
        /></td>
      </tr>
      <tr valign="baseline">
